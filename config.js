System.config({
  ...
  map: {
    ...
    "npm:babel-preset-es2015@6.5.0": {
      ...
      "babel-plugin-transform-es2015-modules-commonjs": "npm:babel-plugin-transform-es2015-modules-commonjs@6.5.2",
